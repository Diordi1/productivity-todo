...
let Home=()=>{
    ...
    return    <>
     ...
     <body className="d-flex align-items-center py-4 bg-body-tertiary container w-25" cz-shortcut-listen="true" >
...
<main className="form-signin w-100 m-auto">
  ...
  <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
    ...
    <div className="form-floating">
      <input type="email" name="user" className="form-control" id="floatingInput" placeholder="name@example.com" onChange={handleChange} value={Details.user}/>
      <label for="floatingInput">Email address</label>
    </div>
    <div className="form-floating">
      <input type="password" name="pass" className="form-control" id="floatingPassword" placeholder="Password" onChange={handleChange} value={Details.pass}/>
